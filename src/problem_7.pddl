(define
    ...
    (:init
        ...
        (item-at package2 three three)
        (item-at package3 four four)
        (item-at package4 seventeen seventeen)
        (item-at package5 eighteen eighteen)
        (item-at package6 nineteen nineteen)
    ...
    (:goal (and
            ...
            (item-at package4 one one)
            (item-at package5 one one)
            (item-at package6 one one)
        )
    )
