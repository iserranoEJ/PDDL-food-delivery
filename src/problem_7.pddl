(define
    ...
    (:init
        ...
        (item-at package1 seventeen eighteen)
        (item-at package2 sixteen sixteen)
        (item-at package3 nineteen eighteen)
        (item-at package4 five five)
        (item-at package5 one one)
        (item-at package6 two two)
    ...
    (:goal (and
            ...
            (item-at package3 twenty twenty)
            (item-at package4 nine nine)
            (item-at package5 ten ten)
            (item-at package6 four five)
        )
    )
